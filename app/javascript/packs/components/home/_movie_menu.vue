...
<script>
 ...
 const watchable = {
  ...
  attributes: {
   ...
   reviews_count: 2,
   description: "Saber como criar e consumir API 's é fundamental paraqualquer programador, então nessa pequena série nós vamos ver o que é essencial para criar uma usando RoR.",
